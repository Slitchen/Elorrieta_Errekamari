...
import java.awt.event.ActionEvent;
	...
	public class KatalogoErretzaile {
		...
		public KatalogoErretzaile(Scanner sc, String[] motak, String[] izenak, String[] kodeak, Double[] prezioak,
				String[] argazkiIzenak, int produktuKop) {
			katalogoErretzaile(sc, motak, izenak, kodeak, prezioak, argazkiIzenak, produktuKop);
		}
		private void katalogoErretzaile(Scanner sc, String[] motak, String[] izenak, String[] kodeak, Double[] prezioak,
				String[] argazkiIzenak, int produktuKop) {
			frame = new JFrame();
			...
			panela.setLayout(null);
						...
						labelak(panelb, lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7, lbl8, lbl9, motak, izenak, kodeak, prezioak, argazkiIzenak, produktuKop);
						argazkiak(lblP1, lblP2, lblP3, lblP4, lblP5, lblP6, lblP7, lblP8, lblP9, motak, izenak, kodeak, prezioak, argazkiIzenak, produktuKop);;
	...
	// Verificar si el producto es de tipo "edaria" y tiene una imagen
				if (izenak[i] != null && motak[i] != null && motak[i].equals("erretzaile") && argazkiIzenak[i] != null) {
	...
	// Limpiar los JLabel restantes si no se usaron todos
		...
		public static void labelak(JPanel panelb, JLabel lbl1, JLabel lbl2, JLabel lbl3, JLabel lbl4, JLabel lbl5, JLabel lbl6, JLabel lbl7, JLabel lbl8, JLabel lbl9, String[] motak,
			...
			for (int i = 0; i < produktuKop; i++) {
			if (izenak[i] != null && motak[i] != null && motak[i].equals("erretzaile")){
				switch (labelIndex) {
				case 1:
