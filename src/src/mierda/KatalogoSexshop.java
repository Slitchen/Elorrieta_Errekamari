...
import java.awt.event.ActionEvent;
	...
	public class KatalogoSexshop {
		...
		public KatalogoSexshop(Scanner sc, String[] motak, String[] izenak, String[] kodeak, Double[] prezioak,
				String[] argazkiIzenak, int produktuKop) {
			katalogoSexshop(sc, motak, izenak, kodeak, prezioak, argazkiIzenak, produktuKop);
		}
	
		private void katalogoSexshop(Scanner sc, String[] motak, String[] izenak, String[] kodeak, Double[] prezioak,
				String[] argazkiIzenak, int produktuKop) {
	...
	// Verificar si el producto es de tipo "edaria" y tiene una imagen
				if (izenak[i] != null && motak[i] != null && motak[i].equals("sexshop") && argazkiIzenak[i] != null) {
	...
	// Limpiar los JLabel restantes si no se usaron todos
		...
		public static void labelak(JPanel panelb, JLabel lbl1, JLabel lbl2, JLabel lbl3, JLabel lbl4, JLabel lbl5, JLabel lbl6, JLabel lbl7, JLabel lbl8, JLabel lbl9, String[] motak,
			...
			for (int i = 0; i < produktuKop; i++) {
			if (izenak[i] != null && motak[i] != null && motak[i].equals("sexshop")){
				switch (labelIndex) {
				case 1:
