...
public class KatalogoEdaria {
	...
	DefaultTableModel produktu = new DefaultTableModel();
	...
	public void katalogoEdaria() {
		...
		Image image1 = imageIcon1.getImage().getScaledInstance(lblP1.getWidth(), lblP1.getHeight(), Image.SCALE_SMOOTH);
		imageIcon1.setImage(image1);
		lblP1.setIcon(imageIcon1);

		imageIcon2 = new ImageIcon(this.getClass().getResource("/torolocoOpalo.jpg"));
		Image image2 = imageIcon2.getImage().getScaledInstance(lblP2.getWidth(), lblP2.getHeight(), Image.SCALE_SMOOTH);
		imageIcon2.setImage(image2);
		lblP2.setIcon(imageIcon2);

		imageIcon3 = new ImageIcon(this.getClass().getResource("/torolocoMango.jpg"));
		Image image3 = imageIcon3.getImage().getScaledInstance(lblP3.getWidth(), lblP3.getHeight(), Image.SCALE_SMOOTH);
		imageIcon3.setImage(image3);
		lblP3.setIcon(imageIcon3);

		imageIcon4 = new ImageIcon(this.getClass().getResource("/monsterZuria.jpg"));
		Image image4 = imageIcon4.getImage().getScaledInstance(lblP4.getWidth(), lblP4.getHeight(), Image.SCALE_SMOOTH);
	...
	public void btn4() {
		...
		txtPrezio.setText("1€");
		produktua = "Monster Zuria";
		prezioa = 1;
		kantitatea++;
	}

	/*
	 * public void btnIntro() { Laburpena.setAldagaiak(produktua, prezioa,
	 * kantitatea); }
	 */
}
