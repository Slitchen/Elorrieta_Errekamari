	...
	public static void menu1(Scanner sc, String[] motak, String[] izenak, String[] kodeak, Double[] prezioak, String[] argazkiIzenak, int produktuKop) {
		...
		do {
					...
					if (kode1.equals(kodeak[i])) {
						...
						if (baiEZ == true) {
							...
							for (i = 0; i < izenak.length; i++) {
								if (izenak[i] != null) {
									System.out.println(i + 1 + "." + " " + "Mota: " + motak[i] + " " + "Izena: "
											+ izenak[i] + " " + "Kodea: " + kodeak[i] + " " + "Prezioa: " + prezioak[i]
											+ "€" + " " + "Argazki_Izena: " + argazkiIzenak[i]);
								}
							}
							System.out.println("***********************************");
			...
			case 3:
				...
				do {
					/*
					 * do { System.out.println("Ipini produktuen mota: "); mota1 = sc.nextLine();
					 * balidatuta= balidatuMota(mota1); }while(balidatuta==false);
					 */
					/*
					 * do { System.out.println("Ipini produktuen izena: "); izena1= sc.nextLine();
					 * balidatuta= balidatuIzena(izena1); }while(balidatuta==false);
					 */
					do {
						System.out.println("Ipini produktuen kodea: ");
						kode1 = sc.nextLine();
